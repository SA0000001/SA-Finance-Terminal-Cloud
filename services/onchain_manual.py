...
METRIC_LABELS: dict[str, str] = {
    ...
    "exchange_reserve":    "Exchange Reserve — All Exchanges (USD milyon)",
...
METRIC_HELP: dict[str, str] = {
    ...
    "exchange_reserve":    "Tüm borsalardaki toplam BTC değeri USD milyon cinsinden — düşüş trendi bullish (örn. CryptoQuant'ta 2.72M görünüyorsa 2.72 gir)",
